...
Public Class FormSubAkunAJP
    ...
    Private Sub AmbilData()
        With ListView1.SelectedItems
            FormAJP.txtNoAkun.Text = .Item(0).SubItems(0).Text
            FormAJP.lblNamaAkun.Text = .Item(0).SubItems(1).Text
        End With
    End Sub

    Private Sub FormSubAkunAJP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            BukaKoneksi()
            PosisiList()
            IsiList()
