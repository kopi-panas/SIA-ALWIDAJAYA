...
Public Class FormSubAJP
    ...
    Private Sub txtNoTransaksi_TextChanged(sender As Object, e As EventArgs) Handles txtNoTransaksi.TextChanged
        Try
            Query = "SELECT tbl_jurnalajp.Periode, tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status FROM(tbl_jurnalajp) GROUP BY tbl_jurnalajp.Periode, tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status HAVING(((tbl_jurnalajp.Periode) = '" & cbPeriode.Text & "') And ((tbl_jurnalajp.NoTransaksi) Like '" & txtNoTransaksi.Text & "%" & "')) ORDER BY tbl_jurnalajp.Periode, tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status"
            Da = New OleDbDataAdapter(Query, CONN)
            Ds = New DataSet
            Da.Fill(Ds)
    ...
    Private Sub cbPeriode_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbPeriode.SelectedIndexChanged
        Try
            Query = "SELECT tbl_jurnalajp.Periode, tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status FROM(tbl_jurnalajp) GROUP BY tbl_jurnalajp.Periode, tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status HAVING(((tbl_jurnalajp.Periode) = '" & cbPeriode.Text & "')) ORDER BY tbl_jurnalajp.Periode DESC , tbl_jurnalajp.TglTransaksi, tbl_jurnalajp.NoTransaksi, tbl_jurnalajp.Keterangan, tbl_jurnalajp.Status"
            Da = New OleDbDataAdapter(Query, CONN)
            Ds = New DataSet
            Da.Fill(Ds)
